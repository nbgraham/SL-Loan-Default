...
class DecisionTreeClassifier:
    def __init__(self, max_depth=None, min_split_size=None, remainder_score='entropy', show_progress=False):
        self.tree = None
    ...
    def fit(self,x,y, attributes, attr_allowed=None):
        x = np.array(x)
        self.x_shape = x[0].shape

        if attr_allowed is None:
